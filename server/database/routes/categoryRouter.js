...
router
    ...
    .get( ( req, res ) =>
    {
        ...
        Category
            ...
            .catch( err =>
            {
                res.status( 500 ).json( { errorMessage: "I aint got a Category called that...." } );
            } )
    } )
    ...
    .delete( ( req, res ) =>
    {
        ...
        // findByIdAndUpdate
        Category
            .findByIdAndRemove( id /*, updates, { title } = req.body*/ )
            ...
            .catch( err =>
            {
                res.status( 500 ).json( { status: 'That Category aint here buddy. Check your bank account to make sure you still have money!' } );
            } )
        // res.json(200).json({ status: 'please implement PUT functionality' });
    } )
