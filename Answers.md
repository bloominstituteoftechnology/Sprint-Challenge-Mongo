# 1) A database is a structured set of data in a computer that can be accessed in various ways. The document a the unit of storing data (uses JSON for storing data). A collection can store many documents.
